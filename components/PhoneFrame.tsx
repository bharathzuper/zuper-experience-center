...
import type { AudioCall } from "@/lib/features";
...
export default function PhoneFrame({ calls }: PhoneFrameProps) {
  ...
  const currentUrl = activeCall !== null ? calls[activeCall]?.url ?? "" : "";
  const currentCallData = activeCall !== null ? calls[activeCall] : null;
  ...
  return (
    <div className="phone-frame-container">
      {currentUrl && (
        <audio ref={audioRef} src={currentUrl} preload="metadata" key={currentUrl} />
      )}
        ...
        <div className="phone-screen">
          ...
          {activeCall === null ? (
            ...
            <div className="phone-call-log">
              ...
              <h3 className="phone-log-title">Recents</h3>

              <div className="phone-log-list">
                {calls.map((call, i) => (
                  <button
                    key={i}
                    className="phone-log-entry"
                    onClick={() => openCall(i)}
                  >
                    <div className="phone-log-avatar">
                      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
                        <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 22 16.92z" />
                      </svg>
                    </div>
                    <div className="phone-log-info">
                      <span className="phone-log-caller">{call.caller}</span>
                      <span className="phone-log-meta">
                        <span className="phone-log-label">{call.label}</span>
                        <span className="phone-log-dot">&middot;</span>
                        <span>{call.time}</span>
                      </span>
                    </div>
                    <div className="phone-log-play">
              ...
              <div className="phone-log-footer">
                <p className="phone-log-hint">Tap a call to listen to the AI conversation</p>
              </div>
            ...
            <div className="phone-call-ui">
              ...
              <button className="phone-back-btn" onClick={goBack}>
              ...
              <div className="phone-contact">
                ...
                <h3 className="phone-caller-name">{currentCallData?.caller ?? "Zuper AI"}</h3>
                <p className="phone-call-label-text">{currentCallData?.label}</p>
